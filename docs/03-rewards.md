...
| ID | 名称 | 条件 | 奖励 |
|---|---|---|---|
| `first_feed` | 初次见面 | 首次喂食 | 10 |
| `streak_3` | 三日之交 | 连续 3 天 | 20 |
| `streak_7` | 一周之约 | 连续 7 天 | 50 |
| `streak_15` | 半月同行 | 连续 15 天 | 100 |
| `streak_30` | 满月 | 连续 30 天 | 200 |

### 成长（4 条，445 枚）

| ID | 名称 | 条件 | 奖励 |
|---|---|---|---|
| `stage_growing` | 长大了 | 到成长期（3 天） | 15 |
| `stage_adult` | 成年礼 | 到成年期（7 天） | 30 |
| `stage_elder` | 老伙计 | 到老年期（30 天） | 100 |
| `age_100` | 百日 | 相伴 100 天 | 300 |

### 照料（5 条，320 枚）

| ID | 名称 | 条件 | 奖励 |
|---|---|---|---|
| `feed_50` | 勤劳饲主 | 累计喂食 50 次 | 40 |
| `feed_200` | 大厨 | 累计喂食 200 次 | 120 |
| `play_30` | 玩伴 | 累计玩耍 30 次 | 30 |
| `clean_20` | 爱干净 | 累计洗澡 20 次 | 30 |
| `clean_100` | 洁癖 | 累计洗澡 100 次 | 100 |

### 美食（3 条，120 枚）

| ID | 名称 | 条件 | 奖励 |
|---|---|---|---|
| `food_can` | 尝鲜 | 首次喂罐头 | 15 |
| `food_fish` | 奢侈 | 首次喂小鱼干 | 25 |
| `food_fish_20` | 小鱼干爱好者 | 喂小鱼干 20 次 | 80 |

### 收藏（2 条，70 枚）

| ID | 名称 | 条件 | 奖励 |
|---|---|---|---|
| `breed_2` | 换个伙伴 | 养过 2 种品种 | 30 |
| `color_4` | 配色师 | 试过 4 种毛色 | 40 |

## 成就总量的意义

**1335 枚 ≈ 53 天的日常开销**（按 25 枚/天算）。
